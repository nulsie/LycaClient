...
the first minor update for v1.3 is here, this is, as the name suggests, a small update. i've added two new features:

* **character limit and meter**: A character limit/meter for the post feature.
* **followers stat and the followers list is now viewable**: yeah i made the followers stat a clickable feature and now you can view the followers list of the user you're searching for.

These are basic but pretty important, so i added them as fast as possible.
